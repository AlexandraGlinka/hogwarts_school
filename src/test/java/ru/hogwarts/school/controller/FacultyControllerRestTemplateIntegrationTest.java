...
public class FacultyControllerRestTemplateIntegrationTest{
    ...
    public void testGetFacultiesByName() throws Exception {
        Faculty testFaculty1 = new Faculty("aaa", "white");
        Faculty testFaculty2 = new Faculty("bbb", "white");
        Faculty testFaculty3 = new Faculty("aaa", "pink");
        ...
        Assertions.assertThat(facultyEntity.getBody()).contains(newFaculty3);
        Assertions.assertThat(facultyEntity.getBody()).doesNotContain(newFaculty2);
    }
